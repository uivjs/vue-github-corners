...
export type TabPaneProps = ExtractPublicPropTypes<typeof gihubCorners>;
...
export default defineComponent({
  ...
  setup(props) {
    return () => {
      ...
      const styl: StandardLonghandProperties<string | number> =
        position === 'left' ? { left: 0, transform: 'scale(-1, 1)' } : { right: 0 };
      if (bottom) {
        styl.bottom = 0;
        styl.top = 'initial';
      ...
      return (
        <a class="github-corner" href={href} aria-label="View source on GitHub">
          <svg
            width={size}
            height={size}
            viewBox="0 0 250 250"
